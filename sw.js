const CACHE='mural-mobile-v6';
const SHELL=['./','./index.html','./mobile.css?v=3','./mobile.js?v=4','./model.js?v=2','./tagger.js?v=1','./sync.js?v=2','./sync-config.js?v=3','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./icons/apple-touch-icon.png'];
