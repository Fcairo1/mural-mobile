const CACHE='mural-mobile-v4';
const SHELL=['./','./index.html','./mobile.css?v=2','./mobile.js?v=3','./model.js?v=2','./tagger.js?v=1','./sync.js?v=2','./sync-config.js?v=2','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./icons/apple-touch-icon.png'];
